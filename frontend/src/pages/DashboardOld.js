                  ...
                  <div className="card-body">
                     <div className="progress-widget">
                        <div id="circle-progress-01" className="text-center circle-progress-01 circle-progress circle-progress-primary" data-min-value="0" data-max-value="100" data-value="90" data-type="percent">
                           <svg className="card-slie-arrow icon-24" width="24"  viewBox="0 0 24 24">
                  ...
                  <div className="card-body">
                     <div className="progress-widget">
                        <div id="circle-progress-04" className="text-center circle-progress-01 circle-progress circle-progress-info" data-min-value="0" data-max-value="100" data-value="60" data-type="percent">
                           <svg className="card-slie-arrow icon-24" width="24px"  viewBox="0 0 24 24">
                              <path fill="currentColor" d="M5,17.59L15.59,7H9V5H19V15H17V8.41L6.41,19L5,17.59Z" />
                           </svg>
                        </div>
                        <div className="progress-detail">
               ...
               <div className="flex-wrap card-header d-flex justify-content-between align-items-center">
                  ...
                  <div className="d-flex align-items-center align-self-center">
                     <div className="d-flex align-items-center text-primary">
                        <svg className="icon-12" xmlns="http://www.w3.org/2000/svg" width="12" viewBox="0 0 24 24" fill="currentColor">
                           <g>
                  ...
                  <div className="dropdown">
                     <a href="#" className="text-gray dropdown-toggle" id="dropdownMenuButton22" data-bs-toggle="dropdown" aria-expanded="false">
                     This Week
                     </a>
         ...
         <div className="col-md-12 col-xl-6">
            <div className="card" data-aos="fade-up" data-aos-delay="900">
               <div className="flex-wrap card-header d-flex justify-content-between">
                  ...
                  <div className="dropdown">
                     <a href="#" className="text-gray dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        This Week
                     </a>
               ...
               <div className="card-body">
                  <div className="flex-wrap d-flex align-items-center justify-content-between">
                     <div id="myChart" className="col-md-8 col-lg-8 myChart"></div>
                     <div className="d-grid gap col-md-4 col-lg-4">
                        <div className="d-flex align-items-start">
                           <svg className="mt-2 icon-14" xmlns="http://www.w3.org/2000/svg" width="14" viewBox="0 0 24 24" fill="#3a57e8">
                              <g>
                        ...
                        <div className="d-flex align-items-start">
                           <svg className="mt-2 icon-14" xmlns="http://www.w3.org/2000/svg" width="14" viewBox="0 0 24 24" fill="#4bc7d2">
                              <g>
            ...
            <div className="overflow-hidden card" data-aos="fade-up" data-aos-delay="600">
               <div className="flex-wrap card-header d-flex justify-content-between">
                  <div className="header-title">
                     ...
                     <p className="mb-0">
                        <svg className ="me-2 text-primary icon-24" width="24"  viewBox="0 0 24 24">
                     ...
                     <table id="basic-table" className="table mb-0 table-striped" role="grid">
                        ...
                        <tbody>
                           <tr>
                              <td>
                                 <div className="d-flex align-items-center">
                                    <Image className="rounded bg-soft-primary Image-fluid avatar-40 me-3" src="../assets/dashboard/images/shapes/01.png" alt="profile" />
                              ...
                              <td>
                                 ...
                                 <div className="shadow-none progress bg-soft-primary w-100"  style={{ height: "4px" }}>
                                    <div className="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 <div className="d-flex align-items-center">
                                    <Image className="rounded bg-soft-primary Image-fluid avatar-40 me-3" src="../assets/dashboard/images/shapes/05.png" alt="profile" />
                              ...
                              <td>
                                 ...
                                 <div className="shadow-none progress bg-soft-primary w-100" style={{ height: "4px" }}>
                                    <div className="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 <div className="d-flex align-items-center">
                                    <Image className="rounded bg-soft-primary Image-fluid avatar-40 me-3" src="../assets/dashboard/images/shapes/02.png" alt="profile" />
                              ...
                              <td>
                                 ...
                                 <div className="shadow-none progress bg-soft-success w-100" style={{ height: "4px" }}>
                                    <div className="progress-bar bg-success" data-toggle="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                 </div>
                              </td>
                           </tr>
                           <tr>
                              <td>
                                 <div className="d-flex align-items-center">
                                    <Image className="rounded bg-soft-primary Image-fluid avatar-40 me-3" src="../assets/dashboard/images/shapes/03.png" alt="profile" />
                           ...
                           <tr>
                              <td>
                                 <div className="d-flex align-items-center">
                                    <Image className="rounded bg-soft-primary Image-fluid avatar-40 me-3" src="../assets/dashboard/images/shapes/04.png" alt="profile" />
                              ...
                              <td>
                                 ...
                                 <div className="shadow-none progress bg-soft-primary w-100" style={{ height: "4px" }}>
                                    <div className="progress-bar bg-primary" data-toggle="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                 </div>
                              </td>
                           </tr>
                        </tbody>
                  ...
                  <div className="p-4 border border-white rounded primary-gradient-card">
                     <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="master-card-content">
                           <svg className="master-card-1 icon-60" width="60"  viewBox="0 0 24 24">
                              <path fill="#ffffff" d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />
                           </svg>
                           <svg className="master-card-2 icon-60" width="60"  viewBox="0 0 24 24">
                              <path fill="#ffffff" d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />
                           </svg>
                        </div>
                     </div>
            ...
            <div className="card" data-aos="fade-up" data-aos-delay="600">
               <div className="flex-wrap card-header d-flex justify-content-between">
                  <div className="header-title">
                     ...
                     <p className="mb-0">
                        <svg className ="me-2 icon-24" width="24" height="24" viewBox="0 0 24 24">
