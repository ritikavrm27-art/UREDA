            ...
            <Link to="/dashboard" className="navbar-brand">
                <div className="logo-main">
                    <div className="logo-normal">
                        <Image src="../assets/images/logo.png" alt="logo" className=" icon-30" />
                    </div>
                    <div className="logo-mini">
                        <Image src="../assets/images/logo.png" alt="logo" className=" icon-30" />
                    </div>
                </div>
                <h4 className="logo-title">UREDA</h4>
            </Link>
        ...
        <div className="sidebar-body pt-0 data-scrollbar">
            <div className="sidebar-list">
                <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li className="nav-item static-item">
                        <a className="nav-link static-item disabled" href="#" tabindex="-1">
                            <span className="default-icon">Masters</span>
                            <span className="mini-icon">-</span>
                        </a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" data-bs-toggle="collapse" href="#sidebar-special" role="button" aria-expanded="false" aria-controls="sidebar-special">
                            ...
                            <span className="item-name">Office</span>
                        ...
                        <ul className="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                            <li className="nav-item">
                                <Link to="/master/office" className="nav-link ">
                                  <i className="icon">
                                  ...
                                  <span className="item-name">Add Office</span>
                                </Link>
                            </li>
                        </ul>
                    </li>
